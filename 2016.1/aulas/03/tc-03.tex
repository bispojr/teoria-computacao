	...
	\begin{frame}{Pensamento}
		\begin{columns}
			...
			\column{.6\textwidth}  		
				\begin{block}{Frase}
					\begin{center}
						{\large A moderação e a coragem, portanto, são destruídas pela deficiência e pelo excesso e preservadas pelo meio termo.}
					\end{center}
				\end{block}		  		
		  		\begin{block}{Quem?}
		  			\begin{center}
						{\bf Aristóteles (384 a.C. - 322 a.C.)} \\Filósofo e lógico grego.
					\end{center}
				\end{block}
		\end{columns}
	\end{frame}
